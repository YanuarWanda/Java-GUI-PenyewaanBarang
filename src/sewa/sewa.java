...
public class sewa {
    ...
    public sewa(int id, String noKTPPenyewa, int idPegawai, int idCabang, 
            Date tanggalPeminjaman, Date peminjamanSampai, Date tanggalPengembalian, float total, float denda) {
        this.id = id;
